...
- Automatically set your user status as Away or Do Not Disturb during eligible calendar meetings.
- Automatically set an "In a meeting" custom status during eligible calendar meetings.

See [Which events the plugin treats as meetings](usage.md#which-events-the-plugin-treats-as-meetings) for the conditions an event must meet before your status is updated.
